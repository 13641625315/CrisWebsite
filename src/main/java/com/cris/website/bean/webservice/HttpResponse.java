...
public class HttpResponse
{
	...
	public String toString()
	{
		...
		{
			response.append("  responseHeaders : " + responseHeaders[i].toString() + ",\n");
		}

		response.append("  stringResult : " + stringResult + ",\n");

		if (byteResult != null)
		{
			final String temp = new String(byteResult);
			response.append("  byteResult : " + temp + ",\n");
		}

		response.append("  contentLength : ");
		response.append(contentLength);
		response.append(",\n");
		response.append("  contentType : " + contentType + ",\n}");
